...
public class JsonWriterTest {
  ...
  @Test
  public void ofNonStreamable_writes_when_closing_json_writer() {
    underTest = JsonWriter.ofNonStreamable(stringWriter);
    underTest.beginObject().prop("open", "bar").endObject();

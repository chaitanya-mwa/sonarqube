...
class ComponentDtoToWsComponent {
  ...
  static Component.Builder componentDtoToWsComponent(ComponentDto component, Map<MetricDto, CurrentMeasureDto> measuresByMetric,
    ...
    for (Map.Entry<MetricDto, CurrentMeasureDto> entry : measuresByMetric.entrySet()) {
